    ...
    return (
      <div className="h-screen w-screen flex items-center justify-center bg-slate-50">
        ...
        >
          ...
          <p className="text-slate-400 font-black animate-pulse tracking-[0.3em] uppercase text-[10px]">
            Verifying Clearance
          </p>
        </motion.div>
      </div>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-500 text-sm font-medium leading-relaxed italic">
              Level {user.role.toUpperCase()} credentials lack the necessary
              clearance for this system module.
            </p>
          </div>
          <button
